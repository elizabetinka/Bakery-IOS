...
//        
//        if (model.button != nil) {
//             registrationButton.configure(with: model.button!)
//        }
...
//        }
//        if (model.nameTextField != nil) {
//            nameTextField.configure(with: model.nameTextField!)
//        }
//        if (model.titleLabel != nil){
//            registrationTextLabel.configure(with: model.titleLabel!)
//        }
...
//    
//    func getInfo() -> UserRegistrationViewInfo{
//        return .init(phoneTextField : phoneTextField.getInfo() , nameTextField: nameTextField.getInfo())
//    }
//    
//    func showLoading() {
